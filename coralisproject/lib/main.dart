...
//     var url = Uri.parse('http://10.34.88.5:8080/api/login');
...
//           SnackBar(content: Text("Login Sukses: ${data['message']}")),
//         );
//       } else {
...
//     } catch (e) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text("Cek IP Laptop & Koneksi Wi-Fi!")),
//       );
//     }
//   }
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: const Text("Coralis Technical Test")),
//       body: Padding(
...
const String baseUrl = "http://10.34.88.5:8080/api";
